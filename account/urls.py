...
urlpatterns = [
    ...
    url(r'^employeeexperience/', views.employeeexperience,
        name='employeeexperience'),
    url(r'^employeedegree/', views.employeedegree, name='employeedegree'),
    url(r'^employeecv/(?P<id>[0-9]+)$',
        views.user_existingcv, name='user_existingcv'),
    ...
    url(r'^allvacancy/(?P<id>[0-9]+)/readmore/$',
        views.readmore, name='readmore'),
    url(r'^allvacancy/(?P<id>[0-9]+)/update/$',
        views.updatevacancy, name='updatevacancy'),
    url(r'^allvacancy/(?P<id>[0-9]+)/delete/$',
        views.deletevacancy, name='deletevacancy'),
    url(r'^user_update/$', views.updateuser, name='updateuser'),
    url(r'^user_update_skill/$', views.updateuserskill, name='updateuserskill'),
    url(r'^user_update_skill/(?P<id>[0-9]+)/delete/$',
        views.deleteuserskill, name='deleteuserskill'),
    url(r'^user_cv/$', views.user_cv, name='user_cv'),
    url(r'^user_cv/(?P<id>[0-9]+)/deleteusercv/$',
        views.deleteusercv, name='deleteusercv'),
    url(r'^updateusercv/$', views.updateusercv, name='updateusercv'),
    url(r'^companyvacancyclick/$', views.companyvacancyclick,
        name='companyvacancyclick'),
    url(r'^companyvacancyclick/(?P<id>[0-9]+)/$',
        views.companyvacancyclickdetails, name='companyvacancyclickdetails'),
    url(r'^Contact_Us/', views.Contact_Us, name='Contact_Us'),
    url(r'^list_of_applicant/(?P<id>[0-9]+)/$',
        views.list_of_applicant, name='list_of_applicant'),
